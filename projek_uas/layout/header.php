...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">FRM Projek Uas</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-black sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="data_pemasuk.php">
                                <span data-feather="shopping-cart"></span>
                                Data pemasuk
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="data_pembelianproduk.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="data_registrasi.php">
